...
Game *start_new_game(Game *game, Question *questions, int questions_number, const char *player_name, int rows, int
cols);

int choose_answer(WINDOW *new_game, WINDOW *help_window, Question question, Game *game, char *hidden_answers, int
game_w, int game_h);
